...
let transporter = nodemailer.createTransport({
  ...
  auth: {
    user: "vishapvaibhav3@gmail.com", // gmail
...
exports.cookieExtractor = function (req) {
  ...
  token =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY0OWMxZmM5MzIzZGQxNzdjZGIzY2EyZCIsInJvbGUiOiJhZG1pbiIsImlhdCI6MTY4ODEwODA4Nn0.2BBvXFY0P9qcI1jHZh2zsut_pT15q8wY1HIKvZmNI9A";
  return token;
};

exports.sendMail = async function ({ to, subject, text, html }) {
  let info = await transporter.sendMail({
    from: '"E-commerce" <vishapvaibhav3@gmail.com>', // sender address
    to,
    subject,
    text,
    html,
           ...
           <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
             ...
             <tr>
               <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                 <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or concerns about your order, please <a href="vishapvaibhav3@gmail.com">contact us</a>.</p>
               </td>
             </tr>
             <!-- end copy -->
             <!-- start receipt table -->
